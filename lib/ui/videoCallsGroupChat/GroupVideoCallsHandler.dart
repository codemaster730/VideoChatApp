...
class GroupVideoCallsHandler {
  ...
  late GroupStreamStateCallback? onStreamListUpdate;
    ...
    if (isCaller && !callStarted) {
      ...
      await FireStoreUtils.firestore
        ...
        if (byeRequest != null) {
          ...
          print('GroupVideoCallsHandler.bye documentReference.set'
